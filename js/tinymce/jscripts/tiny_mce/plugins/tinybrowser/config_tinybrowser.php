...
$_SESSION['tinybrowser']['path']['root'] = '/bin/'; // upload root directory
$_SESSION['tinybrowser']['path']['image'] = '/bin/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
//IMPORTANT: sometimes the _thumbs folder is not created, and this will cause an infinite redirect loop. Check your uploaded images folder to see if the _thumbs folder was created. if not, create it.

$_SESSION['tinybrowser']['path']['media'] = '/bin/'; // Media files location
$_SESSION['tinybrowser']['path']['file']  = '/bin/'; // Other files location
...
$_SESSION['tinybrowser']['max_quota']    = '500mb'; // should be adjusted to your needs
