...
Language: nl
Author: Rudy Mens
email: ruud[at]lazyadmin[dot]nl updated by fc.stuurman@hccnet.nl
*/
    ...
    define("TB_SESSDENIED", "Deze functie is uitgeschakeld voor de veiligheid redenen - in staat te stellen, kunt u configureren sessie ondersteuning in de configuratie file.");
    define("TB_UPLOADIRNOTCREATED", "De upload directory \"%s\" is niet gemaakt voor het uploaden doel nog niet. Please create it.");
    define("TB_UPLOADIRNOTWRITABLE", "De upload directory \"%s\" is niet beschrijfbaar. Zorg er beschrijfbaar.");
    define("TB_NOT_IN_ALLOWED_DIR", "Het verzoek bestand of de map is niet toegestaan in de directory");
    define("TB_NOT_EXISTS", "Het verzoek bestand of de map bestaat niet");
    define("TB_INVALID_FILETYPE", "U hebt gevraagd ongeldig bestandstype.");
    define("TB_FORBIDDEN_FILEXT", "Je hebt geüpload een bestand met verboden of ongeldige bestandsextensie.");
