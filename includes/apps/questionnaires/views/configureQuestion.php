				...
				if ($_GET['editStep'] == 1) {
					...
					?>
						<tr>						
							...
							<td><input type="text" autocomplete="off" class="<?php echo $qID; ?>" name="RQvalALPHQuestion_<?php echo $qID; ?>_edit_3" value="<?php echo $qLabel; ?>"/>
