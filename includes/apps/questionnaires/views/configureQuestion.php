    ...
    <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
        <table id="configure" class="simpleTable">
            ...
            <tr>
                ...
                <td colspan="2">
                    <input size="75" type="text" name="RQvalALPHQuestions[]" id="RQvalALPHQuestion_1" placeholder="Required Skill" value="<?php echo (isset($_POST['RQvalALPHQuestion'][0])) ? $_POST['RQvalALPHQuestion'][0] : ''; ?>" style="width:250px;" /> 
