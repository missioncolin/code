...
$('.add').live('click', function() { 
    ...
    $('<tr><td>' + $label + '</td><td colspan="2"><input size="75" type="text" name="RQvalALPHQuestions[]" id="RQvalALPHQuestion_' + $count + '" placeholder="Required Skill" value="" /> <a href="#" data-count="' + $count + '" data-label="' + $label + '" class="add">Add Another Question</a></td></tr>').insertAfter($(this).parent().parent());
    $(this).remove();
    return false;
});
